...
void ShowDeviceSize::InsertSize(QString name, QString use, QString free, QString all, int percent)
{
    ...
    this->tableWidget->setRowHeight(row, 28);
	...
	if (percent < 50) {
		qss = "QProgressBar{border-width:0px;border-radius:0px;color:#000000;}"
		      "QProgressBar::chunk{background:rgb(60, 140, 220);}";
	} else if (percent < 90) {
		qss = "QProgressBar{border-width:0px;border-radius:0px;color:#FFFFFF;}"
		      "QProgressBar::chunk{background:rgb(60, 140, 220);}";
	} else {
		qss = "QProgressBar{border-width:0px;border-radius:0px;color:#FFFFFF;}"
